...
extern const std::string NOTIF_TWEET_FAIL;
extern const std::string NOTIF_TWEET_FAIL_INST;
...
extern const std::string TWEET_TITLE = "Tweet away, my boy or girl";
extern const std::string NOTIF_TWEET_SUCCESS = "Tweet succesful!";
extern const std::string NOTIF_TWEET_FAIL = "TWEET FAILED!";
extern const std::string NOTIF_TWEET_FAIL_INST = "Try again or, if the problem persists, re-add this account!";
#endif
